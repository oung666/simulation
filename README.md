...
`qt_frontend_v6` is a lightweight pure-Qt prototype. It does not use
...
```powershell
D:\software\Anaconda\envs\python3.11\python.exe qt_frontend_v6\main.py
```
...
```powershell
D:\software\Anaconda\envs\python3.11\python.exe qt_frontend_v6\tools\download_tiles.py --zoom-min 6 --zoom-max 10 --workers 8
```
