...
from qt_frontend_v6.core.map_document import MapDocument
from qt_frontend_v6.core.scenario import CombatUnit
...
class TerrainClassifier:
    ...
    def validate_deployment_for_unit(self, unit: CombatUnit) -> TerrainCheck:
        ...
        if unit.unit_type in {"facility", "airbase"} and terrain != "land":
